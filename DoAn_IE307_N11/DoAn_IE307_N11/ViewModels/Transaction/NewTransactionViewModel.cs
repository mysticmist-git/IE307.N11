...
namespace DoAn_IE307_N11.ViewModels
{
    public class NewTransactionViewModel : BaseViewModel
    {
        ...
        //        {
        //            TransactionTypeImage = "question_mark.png";

        //            _transactionTypes = new ObservableCollection<TransactionType>(
        //                DependencyService.Get<SQLiteDB>().DB.Table<TransactionType>().ToArray());
        ...
        //                DependencyService.Get<SQLiteDB>().DB.Table<Wallet>().ToArray());
